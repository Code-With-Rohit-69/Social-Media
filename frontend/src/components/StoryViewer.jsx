  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gray-700">
        <div
          className="h-full bg-[#615FFF] transition-all duration-100 linear"
      ...
      <div className="absolute top-4 left-4 flex items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rouned bg-black/50">
        <img
